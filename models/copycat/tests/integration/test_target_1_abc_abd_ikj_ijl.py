...
def test_single_run(monkeypatch):
    ...
    monkeypatch.setattr(a, "choose_neighbour", lambda: b, raising=False)
    monkeypatch.setattr(
        selected_codelet[0],
        "_choose_bond_facet",
    ...
    monkeypatch.setattr(b, "choose_neighbour", lambda: changed_letter, raising=False)
    monkeypatch.setattr(
        selected_codelet[0],
        "_choose_bond_facet",
        lambda *_: copycat.slipnet["letter_category"],
    ...
    monkeypatch.setattr(i, "choose_neighbour", lambda: j, raising=False)
    monkeypatch.setattr(
        selected_codelet[0],
        "_choose_bond_facet",
        lambda *_: copycat.slipnet["letter_category"],
    ...
    monkeypatch.setattr(j, "choose_neighbour", lambda: k, raising=False)
    monkeypatch.setattr(
        selected_codelet[0],
        "_choose_bond_facet",
        lambda *_: copycat.slipnet["letter_category"],
