"""
This test approximates the run of Copycat described on pages 108-113
...
def test_single_run(monkeypatch):
    ...
    # Pages 108-113: abc is a right-going successor group, while kji is
    # perceived as a left-going successor group, supporting the opposite
    # whole-string correspondence and the rightmost-to-leftmost slippage.
    ...
    assert initial_group.group_category is copycat.slipnet["successor_group"]
    assert initial_group.direction_category is copycat.slipnet["right"]
