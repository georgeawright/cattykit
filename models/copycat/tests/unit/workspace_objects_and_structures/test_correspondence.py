...
def test_supports():
    ...
    mapping_2 = SimpleNamespace()
    mapping_2.is_distinguishing = True
    mapping_1.supports = lambda other: other is mapping_2
    mapping_1.is_incompatible_with = lambda other: other != mapping_2

    mapping_3 = SimpleNamespace()
    mapping_3.is_distinguishing = True
...
def test_get_relevant_distinguishing_mappings():
    ...
    distinguishing_not_relevant.is_distinguishing = True
    distinguishing_not_relevant.is_relevant = False

    relevant_not_distinguishing = SimpleNamespace()
    relevant_not_distinguishing.is_distinguishing = False
    relevant_not_distinguishing.is_relevant = True

    relevant_distinguishing = SimpleNamespace()
    relevant_distinguishing.is_distinguishing = True
    relevant_distinguishing.is_relevant = True
    ...
    assert correspondence.relevant_mappings == [
        relevant_not_distinguishing,
        relevant_distinguishing,
    ]
    assert correspondence.distinguishing_mappings == [
        distinguishing_not_relevant,
        relevant_distinguishing,
    ]
    assert correspondence.relevant_distinguishing_mappings == [relevant_distinguishing]
...
def test_is_internally_coherent():
    ...
    second_relevant_distinguishing.is_distinguishing = True
    second_relevant_distinguishing.is_relevant = True
